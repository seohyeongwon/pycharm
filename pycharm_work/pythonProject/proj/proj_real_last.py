...
def inputEvtHandler():
    ...
    init_entry(name, gra, ko, math, eng, total, avg, sch)
...
win = Tk()
win.geometry('%dx%d+%d+%d' %(900, 700, 500, 70))
...
data_list = '''[
    (1,'kim', 101010, 25, 75, 14, 0, 0.0, '서울대')
]'''
...
lbl_title = Label(topFrame, text="과연 나는 서연고 갈까?", font=fontStyle)
